...
void URLLoaderHandler::ReportResult(const std::string& fname,
  ...
  if (instance_) {
    ...
    //   instance_->PostMessage("File open for write failed");
    //   return;
    // }
    ...
    //     instance_->PostMessage("File too big");
    //     return;
    //   }
    //   int64_t offset = 0;
    ...
    //     } else {
    //       instance_->PostMessage("File write failed");
    //       return;
    //     }
    ...
    //   instance_->PostMessage("File fail to flush");
    //   return;
    // }

    // send result to chrome
